...
MODEL_NAME=dit_2b # should be one of the following: dit_l, dit_xl, ssm_l, ssm_xl, dit_2b
EXPR_NAME=train_dit_2b_a100_80g

# 4. run the training script, change other hyperparameters in the config file(if needed)
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export XLA_PYTHON_CLIENT_MEM_FRACTION=.98
