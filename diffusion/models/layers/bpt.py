...
Referece: https://github.com/test-time-training/ttt-lm-jax/blob/ac8cdc8a43b811afe23c27d7e82eed34a747b19c/ttt/models/bpt.py
"""
...
"""
def blockwise_ffn(remat_ffn, inputs, chunk_size=2048, training=True):
    ...
    def scan_ffn(remat_ffn, carry, hidden_states):
        outputs = remat_ffn(hidden_states, training)  # @xinhao: when mlp is rematted, should directly pass `deterministic` instead of using keyword. Otherwise, `deterministic` will be ignored.
