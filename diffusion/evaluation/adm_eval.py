...
def main():
    ...
    parser.add_argument("--ref-batch", help="path to reference batch npz file")
    parser.add_argument("--sample-batch", help="path to sample batch npz file")
    args = parser.parse_args()
    return _run_eval_(args.ref_batch, args.sample_batch)

    
def _run_eval_(ref_batch, sample_batch, evaluator=None, batch_size=64):
    ...
    inception = evaluator.compute_inception_score(sample_acts[0])
